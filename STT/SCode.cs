...
namespace STT
{
    ...
    namespace Code
    {
        public class Language_Azure
        {
            ...
            public const string Arabic_Israel = "ar-IL";
            ...
            public const string Arabic_StateOfPalestinen = "ar-PS";
            public const string Arabic_Syria = "ar-SY";
            public const string Arabic_UnitedArabRmirates = "ar-AE";
            public const string Bulgarian_Bulgaria = "bg-BG";
            public const string Catalan_Spain = "ca-ES";
            public const string Chinese_Cantonese_Traditional = "zh-HK";
            public const string Chinese_Mandarin_Simplified = "zh-CN";
            public const string Chinese_TaiwaneseMandarin = "zh-TW";
            ...
            public const string English_Ghana = "en-GH";
            public const string English_HongKong = "en-HK";
            public const string English_India = "en-IN";
            public const string English_Ireland = "en-IE";
            public const string English_Kenya = "en-KE";
            public const string English_NewZealand = "en-NZ";
            public const string English_Nigeria = "en-NG";
            ...
            public const string English_Tanzania = "en-TZ";
            public const string English_UnitedKingdom = "en-GB";
            public const string English_UnitedState = "en-US";
            public const string EstonianEstonia = "et-EE";
            public const string Filipino_Philippines = "fil-PH";
            ...
            public const string Gujarati_Indian = "gu-IN";
            ...
            public const string Irish_Ireland = "ga-IE";
            ...
            public const string Spanish_Cuba = "es-CU";
            ...
            public const string Spanish_EquatorialGuinea = "es-GQ";
        ...
        public class Language_Google
        {
            ...
            public const string Amharic_Ethiopia = "am-ET";
            ...
            public const string Arabic_Qatar = "ar-QA";
            public const string Arabic_SaudiArabia = "ar-SA";
            public const string Arabic_StateofPalestine = "ar-PS";
            ...
            public const string Azerbaijani_Azerbaijan = "az-AZ";
            public const string Basque_Spain = "eu-ES";
            public const string Bengali_Bangladesh = "bn-BD";
            public const string Bengali_India = "bn-IN";
            public const string Bosnian_BosniaandHerzegovina = "bs-BA";
            public const string Bulgarian_Bulgaria = "bg-BG";
            public const string Burmese_Myanmar = "my-MM";
            public const string Catalan_Spain = "ca-ES";
            public const string Chinese_Cantonese_TraditionalHongKong = "yue-Hant-HK";
            public const string Chinese_Mandarin_Simplified_China = "cmn-Hans-CN";
            public const string Chinese_Mandarin_Traditional_Taiwan = "cmn-Hant-TW";
            public const string Croatian_Croatia = "hr-HR";
            public const string Czech_CzechRepublic = "cs-CZ";
            public const string Danish_Denmark = "da-DK";
            ...
            public const string English_NewZealand = "en-NZ";
            public const string English_Nigeria = "en-NG";
            public const string English_Pakistan = "en-PK";
            public const string English_Philippines = "en-PH";
            public const string English_Singapore = "en-SG";
            public const string English_SouthAfrica = "en-ZA";
            public const string English_Tanzania = "en-TZ";
            ...
            public const string French_France = "fr-FR";
            public const string French_Switzerland = "fr-CH";
            public const string Galician_Spain = "gl-ES";
            ...
            public const string Hebrew_Israel = "iw-IL";
            public const string Hindi_India = "hi-IN";
            public const string Hungarian_Hungary = "hu-HU";
            ...
            public const string Japanese_Japan = "ja-JP";
            public const string Javanese_Indonesia = "jv-ID";
            public const string Kannada_India = "kn-IN";
            public const string Kazakh_Kazakhstan = "kk-KZ";
            public const string Khmer_Cambodia = "km-KH";
            public const string Korean_SouthKorea = "ko-KR";
            public const string Lao_Laos = "lo-LA";
            public const string Latvian_Latvia = "lv-LV";
            public const string Lithuanian_Lithuania = "lt-LT";
            public const string Macedonian_NorthMacedonia = "mk-MK";
            public const string Malay_Malaysia = "ms-MY";
            public const string Malayalam_India = "ml-IN";
            public const string Marathi_India = "mr-IN";
            public const string Mongolian_Mongolia = "mn-MN";
            public const string Nepali_Nepal = "ne-NP";
            public const string NorwegianBokmål_Norway = "no-NO";
            public const string Persian_Iran = "fa-IR";
            public const string Polish_Poland = "pl-PL";
            public const string Portuguese_Brazil = "pt-BR";
            public const string Portuguese_Portugal = "pt-PT";
            public const string Punjabi_GurmukhiIndia = "pa-Guru-IN";
            public const string Romanian_Romania = "ro-RO";
            public const string Russian_Russia = "ru-RU";
            public const string Serbian_Serbia = "sr-RS";
            public const string Sinhala_SriLanka = "si-LK";
            public const string Slovak_Slovakia = "sk-SK";
            public const string Slovenian_Slovenia = "sl-SI";
            public const string Spanish_Argentina = "es-AR";
            public const string Spanish_Bolivia = "es-BO";
            ...
            public const string Spanish_Uruguay = "es-UY";
            public const string Spanish_Venezuela = "es-VE";
            public const string Sundanese_Indonesia = "su-ID";
            public const string Swahili_Kenya = "sw-KE";
            public const string Swahili_Tanzania = "sw-TZ";
            public const string Swedish_Sweden = "sv-SE";
            public const string Tamil_India = "ta-IN";
            public const string Tamil_Malaysia = "ta-MY";
            public const string Tamil_Singapore = "ta-SG";
            public const string Tamil_SriLanka = "ta-LK";
            public const string Telugu_India = "te-IN";
            public const string Thai_Thailand = "th-TH";
            public const string Turkish_Turkey = "tr-TR";
            public const string Ukrainian_Ukraine = "uk-UA";
            public const string Urdu_India = "ur-IN";
            public const string Urdu_Pakistan = "ur-PK";
            public const string Uzbek_Uzbekistan = "uz-UZ";
            public const string Vietnamese_Vietnam = "vi-VN";
            public const string Zulu_SouthAfrica = "zu-ZA";
        }
    }
